...
const EditSecondProduct = () => {
  ...
  const handleDelete = async (secondProductId: number) => {
    try {
      ...
      await axios.delete(`http://localhost:5222/api/SecondProduct/${secondProductId}`);
      ...
      <div className="content-container">
        ...
        <div className="products-section">
          ...
          {/*isModalOpen && currentProduct && (
            <SliderProductModal
              secondProduct={currentProduct}
              closeModal={closeModal}
              updateSecondProduct={updateProduct}
            />
          )*/}
        </div>
      </div>
...
export default EditSecondProduct;